...
namespace LeVeeP5
{
    class OutsideWithHidingPlace:Outside, IHidingPlace
    {
        ...
        /// File: OutsideWithHidingPlace
        /// Date: 4/9/2015
        /// </summary>

        #region Fields

        HidingPlaceStruct[] alienPlaces = new HidingPlaceStruct[3];
        string name;
        string description;
        bool searched = false;
        bool alien1 = false;
        ...
        public OutsideWithHidingPlace(string name, string hidingPlace):base (name)
        {
            this.name = name;
